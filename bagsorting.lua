...
local SortBagsButton = CreateFrame("Button", "SortBagsButton", ContainerFrame1)
SortBagsButton:SetPoint("TOP", ContainerFrame1Name, "TOP", 0, -16)
...
local ntex = SortBagsButton:CreateTexture()
ntex:SetTexture("Interface/Buttons/UI-Panel-Button-Up")
ntex:SetTexCoord(0, 0.625, 0, 0.6875)
ntex:SetAllPoints()    
SortBagsButton:SetNormalTexture(ntex)

local htex = SortBagsButton:CreateTexture()
htex:SetTexture("Interface/Buttons/UI-Panel-Button-Highlight")
htex:SetTexCoord(0, 0.625, 0, 0.6875)
htex:SetAllPoints()
SortBagsButton:SetHighlightTexture(htex)

local ptex = SortBagsButton:CreateTexture()
